...
class Message(Base):
    ...
    synthesis_id = Column(String, ForeignKey("synthesis.id"), index=True, nullable=True)
...
class KnowledgeNode(Base):
    ...
    id = Column(String, primary_key=True, default=gen_id)
    chat_id = Column(String, ForeignKey("chats.id"), index=True)   # 👈 NEW PRIMARY SCOPE
    synthesis_id = Column(String, ForeignKey("synthesis.id"), index=True)
...
class KnowledgeEdge(Base):
    ...
    chat_id = Column(String, ForeignKey("chats.id"), index=True)   # 👈 ADD THIS
