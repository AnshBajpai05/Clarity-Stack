  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.35s var(--ease-snap) both",
        "slide-in": "slide-in 0.35s var(--ease-snap) both",
        "scale-in": "scale-in 0.25s var(--ease-spring) both",
        "fade-in-up": "fade-in-up 0.4s var(--ease-snap) both",
      },
      backgroundImage: {
