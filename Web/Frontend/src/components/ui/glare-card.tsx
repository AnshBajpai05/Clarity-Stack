...
export const GlareCard = ({
  ...
  className?: string;
  /** Override the outer card frame (default: 320px wide, 17/21 aspect) */
  ...
  return (
    <div
      ...
      className={cn(
        "relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[320px] aspect-[17/21]",
        containerClassName,
      )}
      ref={refElement}
      onPointerMove={(event) => {
